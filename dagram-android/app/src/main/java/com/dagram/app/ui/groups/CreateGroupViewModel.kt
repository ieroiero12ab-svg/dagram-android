...
class CreateGroupViewModel @Inject constructor(
    ...
    fun createGroup(name: String, description: String?) {
        ...
        viewModelScope.launch {
            ...
            when (val result = chatRepository.createGroup(name, description, memberIds)) {
                is Result.Success -> _uiState.value = _uiState.value.copy(isLoading = false, createdGroup = result.data)
